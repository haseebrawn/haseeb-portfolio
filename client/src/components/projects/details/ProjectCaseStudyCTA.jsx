          ...
          <div className="grid items-center gap-8 lg:grid-cols-[1fr_auto]">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-8 text-white/80 md:text-lg">
                Work with {profile.name}, {profile.role}, to build a clean,
                scalable, and modern full-stack web application.
              </p>
            </div>
...
export default ProjectCaseStudyCTA